...
local function run(msg, matches)
  ...
  if matches[1] == 'پلاگ' and is_sudo(msg) then --after changed to moderator mode, set only sudo
    return list_all_plugins()
  end

  -- Re-enable a plugin for this chat
  if matches[1] == 'ا' and matches[3] == 'chat' then
    local receiver
= get_receiver(msg)
  ...
  -- Enable a plugin
  if matches[1] == 'ا' and is_sudo(msg) then --after changed to moderator mode, set only sudo
  ...
  if matches[1] == 'ن' and matches[3] == 'chat' then
    local plugin = matches[2]
  ...
  -- Disable a plugin
  if matches[1] == 'ن' and is_sudo(msg) then --after changed to moderator mode, set only sudo
